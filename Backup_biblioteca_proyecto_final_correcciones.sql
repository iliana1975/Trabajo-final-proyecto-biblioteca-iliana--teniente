...
INSERT INTO `autores` VALUES (1,'Vivian','Gornick','1945-05-22','EEUU',3),(2,'Stephen','King','1947-03-12','EEUU',1),(3,'Harper','Lee','1926-11-28','EEUU',NULL),(4,'Mark','Twain','1949-01-22','EEUU',NULL),(5,'Edgard Allan','Poe','1936-02-18','EEUU',NULL),(6,'Gabriel Garcia','Márquez','1927-07-10','México',NULL),(7,'Jorge Luis','Borges','1899-07-15','Argentino',NULL),(8,'Mario','Vargas Llosa','1836-08-18','Perú',NULL),(9,'Leopoldo','Marechal','1900-03-11','Argentino',NULL),(10,'Isabel','Allende','1942-05-03','Chilena',NULL),(11,'Pablo','Neruda','1904-07-10','Chileno',NULL),(12,'Ernesto','Sábato','1911-09-10','Argentino',NULL);
...
INSERT INTO `registro_clientes` VALUES (8,'2024-09-04'),(9,'2024-09-04');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_get_porcentaje_ganacias` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_porcentaje_ganacias`(in V_id_libros int, out V_porcentaje DECIMAL(15,2))
BEGIN
declare existe int;
...
-- Dump completed on 2024-09-04 13:15:06
