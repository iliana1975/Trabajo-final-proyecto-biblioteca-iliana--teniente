...
-- Procedimiento para obtener el porcetaje de ganancia por libro, el mismo se ingresa por una variable de entrada id_libro para 
-- hacer el calculo entre el porcentaje de venta y el costo del mismo, si el id ingresado no existe en la tabla se le informa 
-- al cliente por pantalla
...
-- este trigger suma la cantidad de libros por autor , luego de insertar un registro en la tabla libros... si el autor no tenia libros , 
-- se valida con un if , se le carga un registro 
